...
CHIPSET(0x163F, 0x163F, CHIP_VANGOGH)

CHIPSET(0x164D, 0x164D, CHIP_YELLOW_CARP)
CHIPSET(0x1681, 0x1681, CHIP_YELLOW_CARP)
...
CHIPSET(0x7408, 0x7408, CHIP_ALDEBARAN)
CHIPSET(0x740C, 0x740C, CHIP_ALDEBARAN)
CHIPSET(0x740F, 0x740F, CHIP_ALDEBARAN)
CHIPSET(0x7410, 0x7410, CHIP_ALDEBARAN)

CHIPSET(0x7420, 0x7420, CHIP_BEIGE_GOBY)
CHIPSET(0x7421, 0x7421, CHIP_BEIGE_GOBY)
CHIPSET(0x7422, 0x7422, CHIP_BEIGE_GOBY)
CHIPSET(0x7423, 0x7423, CHIP_BEIGE_GOBY)
CHIPSET(0x743F, 0x743F, CHIP_BEIGE_GOBY)
